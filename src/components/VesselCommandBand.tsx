...
// Secondary facts row beneath, full width, muted: relative position · speed ·
// next port + ETA · master. First element in the inspector, position: sticky —
// when stuck the secondary row collapses so the band tightens to its primary
// row; the collapse chevron reduces it to the name + mode + clock line.
      ...
      <section style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--pad-section)', flexWrap: 'wrap', marginTop: 14 }}>
          ...
          <div style={{ flex: 1, minWidth: 220, textAlign: 'center' }}>
            ...
            <div style={{ marginTop: 6, fontFamily: FONT.data, fontSize: 'var(--type-hero-size)', fontWeight: 500, fontVariantNumeric: 'tabular-nums', color: still ? '#ffffff' : NEUTRAL.ink }}>
        ...
        {/* secondary facts — collapse when stuck: the band tightens to its primary row */}
        {!stuck && (
          <div style={{
