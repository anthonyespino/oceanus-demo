...
export function Sparkline({ values, width = 120, height = 24 }: { values: number[]; width?: number; height?: number }) {
  ...
  return (
    <svg width={width} height={height} style={{ border: '1px solid #ddd', verticalAlign: 'middle' }}>
      <line x1={0} y1={y(0)} x2={width} y2={y(0)} stroke="#ddd" strokeWidth={1} />
      <polyline points={points} fill="none" stroke="#777" strokeWidth={1} />
    </svg>
  );
}
